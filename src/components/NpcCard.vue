<template>
  <div class="npc">
    <h3 class="npc__category">{{ category }}</h3>
    <h1 class="npc__name">{{ npc }}</h1>
    <span class="npc__choose">Choose 1–2:</span>
    <ul>
...
const [category, array] = Object.entries(NPC_DATA).at(props.d66.die1);
const npc = array.at(props.d66.die2);
const moves = NPC_MOVES[npc];

console.log(props.d66.toString(), category, npc);
</script>
